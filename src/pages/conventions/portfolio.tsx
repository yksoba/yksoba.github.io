    ...
    <Layout pageProps={props}>
      ...
      <Box bgcolor="rgba(0,0,0,0.5)">
        ...
        >
          ...
          <p>
            Hi! I’m Soba! I am a digital and traditional artist, and I deal
            mostly in merch as well as at-con traditional commissions! My merch
            is primarily prints, stickers, and charms of my OCs or generic
            species (mostly foxes, admittedly 🦊). My sketch commissions are
            inked and colored on japanese illustration board, and are completed
            at-con. Keep scrolling to see more details!
          </p>
          <p>
            ...
            <AutoLink href="https://bsky.app/profile/yksoba.art" /> for the
            latest art and updates!
          </p>
          ...
          <p>
            You can find photos of my previous table setups below, which will
            have the most comprehensive representation of the kind of merch I
            plan to sell. You can also find some examples at my online store:{" "}
