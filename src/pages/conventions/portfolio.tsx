...
const Page = (props: PageProps) => {
  return (
    ...
    >
      ...
      <FlexCol gap={1} maxWidth="600px" margin="0 auto">
        ...
        <Flex gap={1}>
          <StaticImage
            ...
            alt={"Two stickers of a neapolitan ice cream themed fox character"}
          />
          <StaticImage
      ...
      <p>
        You can also see some of my previous at-con sketch comms which ppl have
        brought home! (May take a moment to load)
      </p>
      <Flex gap={1}>
        <FlexCol width="100%">
          <TweetCard
